...
public class Beverages extends JFrame implements ActionListener {
    String its,ps,ms,bss,css;
    String customerid;
    int c1,c2,c3,c4,c5=0;
    JButton back,plus1,plus2,plus3,plus4,plus5,minus1,minus2,minus3,minus4,minus5;
    JLabel count1,count2,count3,count4,count5;

    Beverages(String customerid) {
        this.customerid = customerid;
        JLabel head = new JLabel("SHAKES");
        head.setFont(new Font("TimesRoman", Font.ITALIC, 35));
        head.setBounds(150, 80, 250, 40);
        add(head);

        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/drink.jpg"));
...
// First Drink
        JLabel it = new JLabel("Cold Coffee");
        it.setBounds(60, 180, 200, 35);
        it.setFont(new Font("TimesRoman", Font.PLAIN, 25));
        add(it);

        ImageIcon iti = new ImageIcon(ClassLoader.getSystemResource("icons/iceTea.jpeg"));
        ...
        // 2nd drink
        JLabel p = new JLabel("Strong Cold Coffee");
        p.setBounds(60, 230, 250, 35);
        p.setFont(new Font("TimesRoman", Font.PLAIN, 25));
        add(p);

        ImageIcon pi = new ImageIcon(ClassLoader.getSystemResource("icons/pepsi.jpeg"));
        ...
        // 3rd drink
        JLabel m = new JLabel("Kit Kat");
        m.setBounds(60, 280, 250, 35);
        m.setFont(new Font("TimesRoman", Font.PLAIN, 25));
        add(m);

        ImageIcon mi = new ImageIcon(ClassLoader.getSystemResource("icons/mirinda.jpeg"));
        ...
        // 4th drink
        JLabel cs = new JLabel("Oreo");
        cs.setBounds(60, 330, 250, 35);
        cs.setFont(new Font("TimesRoman", Font.PLAIN, 25));
        add(cs);

        ImageIcon csi = new ImageIcon(ClassLoader.getSystemResource("icons/chocolateShake.jpeg"));
        ...
        // 5th Drink
        JLabel bs = new JLabel("Cold Drink");
        bs.setBounds(60, 380, 250, 35);
        bs.setFont(new Font("TimesRoman", Font.PLAIN, 25));
        add(bs);

        ImageIcon bsi = new ImageIcon(ClassLoader.getSystemResource("icons/berryShake.jpeg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(ae.getSource()==back){
            ...
            try{
                Conn c = new Conn();
                String query = "INSERT INTO beverages VALUES('"+customerid+"','"+its+"','"+ps+"','"+ms+"','"+bss+"','"+css+"')";
